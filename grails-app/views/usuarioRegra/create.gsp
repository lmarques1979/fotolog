...
<html>
	<head>
		...
		<title><g:message code="usuarioRegra.create.label" /></title>
	</head>
	<body>
		<a href="#create-usuarioRegra" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-usuarioRegra" class="content scaffold-create" role="main">
			<h1><g:message code="usuarioRegra.create.label"/></h1>
