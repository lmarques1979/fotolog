...
<html>
	<head>
		...
		<title><g:message code="mensagem.edit.label" /></title>
	</head>
	<body>
		<a href="#edit-mensagem" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		
		<div id="edit-mensagem" class="content scaffold-edit" role="main">
			<h1><g:message code="mensagem.edit.label"/></h1>
			...
			<g:form url="[resource:mensagemInstance, action:'update']" method="PUT" >
