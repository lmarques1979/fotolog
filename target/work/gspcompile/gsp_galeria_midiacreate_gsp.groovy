...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'midia.label', default: 'Foto'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
invokeTag('message','g',6,['code':("midia.create.label")],-1)
})
...
printHtmlPart(4)
createTagBody(2, {->
invokeTag('message','g',12,['code':("midia.list.label")],-1)
})
...
invokeTag('eachError','g',24,['bean':(midiaInstance),'var':("error")],3)
printHtmlPart(16)
})
invokeTag('hasErrors','g',26,['bean':(midiaInstance)],2)
printHtmlPart(9)
createTagBody(2, {->
printHtmlPart(17)
...
invokeTag('uploadForm','g',35,['url':([resource:midiaInstance, action:'save'])],2)
printHtmlPart(21)
})
