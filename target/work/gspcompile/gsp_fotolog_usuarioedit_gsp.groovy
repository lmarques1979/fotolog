...
class gsp_fotolog_usuarioedit_gsp extends GroovyPage {
...
printHtmlPart(4)
invokeTag('message','g',13,['code':("usuario.edit.label")],-1)
printHtmlPart(5)
...
invokeTag('eachError','g',21,['bean':(usuarioInstance),'var':("error")],3)
printHtmlPart(15)
})
...
createTagBody(2, {->
printHtmlPart(16)
invokeTag('hiddenField','g',25,['name':("version"),'value':(usuarioInstance?.version)],-1)
printHtmlPart(17)
