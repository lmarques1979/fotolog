...
createTagBody(2, {->
createTagBody(3, {->
invokeTag('message','g',7,['code':("midia.edit.label")],-1)
})
...
printHtmlPart(5)
createTagBody(2, {->
invokeTag('message','g',14,['code':("midia.create.label")],-1)
})
invokeTag('link','g',14,['class':("novo"),'action':("create")],2)
printHtmlPart(6)
invokeTag('message','g',18,['code':("midia.edit.label")],-1)
printHtmlPart(7)
...
invokeTag('eachError','g',26,['bean':(midiaInstance),'var':("error")],3)
printHtmlPart(17)
})
invokeTag('hasErrors','g',28,['bean':(midiaInstance)],2)
printHtmlPart(10)
createTagBody(2, {->
printHtmlPart(18)
invokeTag('hiddenField','g',30,['name':("version"),'value':(midiaInstance?.version)],-1)
printHtmlPart(19)
...
invokeTag('uploadForm','g',37,['url':([resource:midiaInstance, action:'update'])],2)
printHtmlPart(22)
})
