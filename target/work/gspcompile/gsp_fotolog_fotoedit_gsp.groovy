...
class gsp_fotolog_fotoedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/foto/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(6)
invokeTag('message','g',18,['code':("foto.edit.label")],-1)
printHtmlPart(7)
...
invokeTag('eachError','g',26,['bean':(fotoInstance),'var':("error")],3)
printHtmlPart(17)
})
invokeTag('hasErrors','g',28,['bean':(fotoInstance)],2)
printHtmlPart(10)
createTagBody(2, {->
printHtmlPart(18)
invokeTag('hiddenField','g',30,['name':("version"),'value':(fotoInstance?.version)],-1)
printHtmlPart(19)
...
invokeTag('uploadForm','g',37,['url':([resource:fotoInstance, action:'update'])],2)
printHtmlPart(22)
})
